				...
				<table cellspacing="1" cellpadding="4" width="158"
					...
					<TR class=altbg1>
						<TD height=25 width="100%" align="center"  bgcolor="#D6E0EF">
							...
							<img border="0" src="../image/icon_arrow_r.gif" width="13"
								height="13">
							<a class="menu" target="main" href="../showUserList">用户管理&nbsp;&nbsp;</a>
						</TD>
					</TR>
				</table> </span>
				...
				<TABLE cellSpacing="0" cellPadding="0" width="158"
					...
					<TR>
						<TD height=25 width="100%" align="center" bgcolor="#D6E0EF">
							<img border="0" src="../image/icon_arrow_r.gif" width="13"
								height="13">
							<a class="menu" target="main" href="../ManageNews?currentpage=0">管理新闻</a>
						</TD>
					</TR>
				</table> </span>
				...
				<TABLE cellSpacing="0" cellPadding="0" width="158"
					...
					<TR>
						<TD height=25 width="100%" align="center" bgcolor="#D6E0EF">
							<img border="0" src="../image/icon_arrow_r.gif" width="13"
								height="13">
							<a class="menu" target="main" href="../ManageProduct?currentpage=0">管理商品</a>
						</TD>
					</TR>
				</table> </span>
